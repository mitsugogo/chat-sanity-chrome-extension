...
const CANDIDATE_PATTERNS: Array<[RegExp, string]> = [
  ...
  [
    /(?:何して|なんで|早く|はよ|ちゃんと|しっかり|さっさと|しろ|するな|した方|すれば|したら|とけば|行けば|行け|戻れ|仕事しろ|指示しろ|コメ読め|マップ|回復|交代|セーブ|装備|確認|リロード|集中|練習|拡張|勉強|コメント|やめて|やめる|してください|してほしい|してくれ|食ってくれ|しなよ|しなさい|行きなよ|戻りなよ|探しなよ|頼むから|気づいてくれ|慣れろ|食え|逃げろ|探せ|乗れ|食べないと|行かないと|べき|そこじゃない|違うって|早くして)/u,
    '指示・催促構文の候補',
  ],
